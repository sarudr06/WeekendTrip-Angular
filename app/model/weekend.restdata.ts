...
export class WeekendRestData{
  ...
  constructor(private http: HttpClient) {
    ...
    this.baseUrlLogin3 = `${PROTOCOL}://${location.hostname}:${PORT3}/${PROJECT3}/`;
...
getPdf(id:number,amount:number):Observable<Traveller>{

  return this.http.get<Traveller>(`${this.baseUrlLogin3}pdf/user/${id}/${amount}`);
}
